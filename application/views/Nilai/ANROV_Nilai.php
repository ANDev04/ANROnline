    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col s12 right-align">
                <a class="btn-floating btn-large waves-effect waves-light red " href="<?php echo base_url()."ANROC_Exel/import/anr_nilai" ?>"><i class="material-icons right">open_in_browser</i></a>
